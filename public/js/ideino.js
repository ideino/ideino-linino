$(function($) {
  ...
  // ideino view
  ideinoView = Backbone.View.extend({
    el: document.body,
    events: {
  ...
  // ideino instance
  ideino = new ideino(initData);
  // ideino view instance
  ideinoView = new ideinoView({
    model: ideino
  });
});